...
var keycloak_event_1 = require("../interfaces/keycloak-event");
/**
...
var KeycloakService = (function () {
    function KeycloakService() {
        this._keycloakEvents$ = new Subject_1.Subject();
    }
    /**
     ...
     */
    KeycloakService.prototype.sanitizeBearerPrefix = function (bearerPrefix) {
     ...
     */
    KeycloakService.prototype.ifUndefinedIsTrue = function (value) {
    ...
    KeycloakService.prototype.bindsKeycloakEvents = function () {
        ...
        this._instance.onAuthError = function (errorData) {
            _this._keycloakEvents$.next({ args: errorData, type: keycloak_event_1.KeycloakEventType.OnAuthError });
        };
        this._instance.onAuthLogout = function () {
            _this._keycloakEvents$.next({ type: keycloak_event_1.KeycloakEventType.OnAuthLogout });
        };
        this._instance.onAuthRefreshError = function () {
            _this._keycloakEvents$.next({ type: keycloak_event_1.KeycloakEventType.OnAuthRefreshError });
        };
        this._instance.onAuthSuccess = function () {
            _this._keycloakEvents$.next({ type: keycloak_event_1.KeycloakEventType.OnAuthSuccess });
        };
        this._instance.onTokenExpired = function () {
            _this._keycloakEvents$.next({ type: keycloak_event_1.KeycloakEventType.OnTokenExpired });
        };
        this._instance.onReady = function (authenticated) {
            _this._keycloakEvents$.next({ args: authenticated, type: keycloak_event_1.KeycloakEventType.OnReady });
        };
    };
    /**
     ...
     */
    KeycloakService.prototype.isUserInRole = function (role) {
        var hasRole;
    ...
    KeycloakService.prototype.getUserRoles = function (allRoles) {
        ...
        if (allRoles && this._instance.realmAccess) {
            ...
            roles.push.apply(roles, realmRoles);
        }
        return roles;
    };
    /**
     ...
     */
    KeycloakService.prototype.addTokenToHeader = function (headersArg) {
        var _this = this;
