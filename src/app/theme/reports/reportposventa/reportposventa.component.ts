...
@Component({
  selector: 'app-reportposventa',
  templateUrl: './reportposventa.component.html',
  styleUrls: ['./reportposventa.component.scss',
  ...
  providers: [UsuariosService, ConcesionariosService, PosVentasService]
})
export class ReportPosVentaComponent implements OnInit {
  ...
  constructor(private usuarioService: UsuariosService,
    ...
    private ventasService: PosVentasService
  ) {
    this.selectedFilters = new RequestFilters('TOTAL', 'TOTAL', 'TOTAL', 'TOTAL', 'TOTAL', 'TOTAL');
  ...
  getConcesionarios() {
    ...
    if (_user.UsuarioRolID === 'admin') {
      this.usuarioService.getConcesionariosPos().subscribe(
        result => {
  ...
  getAnio() {
    this.usuarioService.getAnioPos().subscribe(
      result => {
  ...
  getMes() {
    this.usuarioService.getMesPos().subscribe(
      result => {
  ...
  getMotivosVisitas() {
    this.chartData1 = [];    
    this.ventasService.getMotivoVisitas(this.selectedFilters).subscribe(
      result => {
  ...
  getSegmentos() {
    this.usuarioService.getSegmentosPos().subscribe(
      result => {
  ...
  getMarcas() {
    this.usuarioService.getMarcaPos().subscribe(
      result => {
  ...
  getMotivos() {
    this.usuarioService.getMotivosPos().subscribe(
      result => {
        this.motivoOptions = result;
  ...
  loadChartFirts() {
    AmCharts.makeChart("chartdiv1", {
      ...
      "graphs": [
        ...
        {
          "balloonText": "Mantenimiento:[[value]]",
          "fillAlphas": 0.8,
          "id": "AmGraph-2",
          "lineAlpha": 0.2,
          "title": "Mantenimiento",
          "type": "column",
          "valueField": "mantenimiento"
        },
        {
          "balloonText": "Carrocería:[[value]]",
          "fillAlphas": 0.8,
          "id": "AmGraph-3",
          "lineAlpha": 0.2,
          "title": "Carrocería",
          "type": "column",
          "valueField": "carroceria"
        }
      ],
      "guides": [],
      "valueAxes": [
